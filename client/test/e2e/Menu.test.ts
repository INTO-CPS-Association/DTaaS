...
async function navigateAndCheckURL(
  page: Page,
...
test.describe('Header Contents and Navigation Links', () => {
  ...
  test('Navigation Links on the dashboard page', async ({ page }) => {
    await navigateAndCheckURL(
      page,
      'div[role="button"]:has-text("Dashboard")',
      '/dashboard'
    );
    await navigateAndCheckURL(
      page,
      'div[role="button"]:has-text("Library")',
      '/library'
    );
    ...
    await navigateAndCheckURL(
      page,
      'div[role="button"]:has-text("Digital Twins")',
      '/digitaltwins'
    );
    ...
    await navigateAndCheckURL(
      page,
      'div[role="button"]:has-text("Scenario Analysis")',
      '/sanalysis'
    );
    ...
    await navigateAndCheckURL(
      page,
      'div[role="button"]:has-text("History")',
      '/history'
    );
  });
