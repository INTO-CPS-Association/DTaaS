...
/**
 * External links open in a new tab. Both tokens of the `rel` are required with
 * `target="_blank"`: without them the opened page can reach back through
 * `window.opener` and navigate this one. `noopener` is named explicitly
 * because older WebKit and Edge do not imply it from `noreferrer`.
 */
...
function Copyright(props: OwnProps) {
  return (
    <Typography variant="body2" color="text.secondary" {...props}>
      {'Copyright © '}
      <Link href={ASSOCIATION_URL} target="_blank" rel="noopener noreferrer">
