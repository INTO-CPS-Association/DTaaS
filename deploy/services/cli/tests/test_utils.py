...
class TestCheckRootUnix:
    """Tests for check_root_unix function"""

    def test_check_root_unix_windows(self):
    ...
    def test_check_root_unix_linux_as_root(self):
    ...
    def test_check_root_unix_linux_not_root(self):
    ...
    def test_check_root_unix_darwin_as_root(self):
    ...
    def test_check_root_unix_darwin_not_root(self):
    ...
    def test_check_root_unix_no_geteuid(self):
...
class TestExecuteDockerCommand:
    """Tests for execute_docker_command function"""

    @patch("dtaas_services.pkg.utils.DockerClient")
    def test_execute_docker_command_success(self, mock_docker_client):
    ...
    @patch("dtaas_services.pkg.utils.DockerClient")
    def test_execute_docker_command_failure(self, mock_docker_client):
    ...
    @patch("dtaas_services.pkg.utils.DockerClient")
    def test_execute_docker_command_verbose_false(self, mock_docker_client):
        """Test Docker command execution with verbose=False"""
        mock_client = Mock()
        mock_docker_client.return_value = mock_client
        mock_client.execute.return_value = "output"
        
        success, output = execute_docker_command("test_container", ["cmd"], verbose=False)
...
class TestGetCredentialsPath:
    ...
    def test_get_credentials_path(self, mock_get_base_dir):
