...
| workspace                                                                                 | User workspace container image                 | [workspace localhost](workspace/dex-localhost.md) and [workspace secure server](workspace/keycloak-server-secure.md) | [docker hub](https://hub.docker.com/r/intocps/workspace) and `intocps/workspace:*` images referenced by deployment packages |
